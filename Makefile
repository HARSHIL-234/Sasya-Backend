...
# Default target
help:
	@echo "🌾 Sasya Agricultural AI Platform - Docker Commands"
	@echo ""
...
# Production commands
build:
	@echo "🏗️  Building Sasya Agricultural AI Platform..."
	docker-compose build

up:
	@echo "🚀 Starting Sasya Agricultural AI Platform..."
	docker-compose up -d
	@echo "✅ Application started! Check http://localhost:8000/docs"

down:
	@echo "🛑 Stopping Sasya Agricultural AI Platform..."
	docker-compose down
...
# Setup commands
setup:
	@echo "⚙️  Setting up Sasya Agricultural AI Platform..."
	@if [ ! -f .env ]; then \
		cp .env.example .env; \
...
start: setup build up test
	@echo "🌟 Sasya Agricultural AI Platform is ready!"
